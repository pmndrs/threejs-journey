...
const ParticlesAnimatedPage = () => {
    return (
        <>
            <SEO title={title} description="Particles-animated example from Three.js Journey course implemented with react-three-fiber" image="/thumbnails/classic-techniques/particles-animated.png" />
