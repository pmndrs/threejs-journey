...
const GalaxyGeneratorPage = () => {
    return (
        <>
            <SEO title={title} description="Galaxy generator example from Three.js Journey course implemented with react-three-fiber" image="/thumbnails/classic-techniques/galaxy-generator.png" />
